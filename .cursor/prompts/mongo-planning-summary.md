...
Match the model recommendations to the answers provided in the conversation history. Identify which recommendations are relevant based on the MongoDB discussion.
...
Please store output in ai/mongo_planning_summary.md file